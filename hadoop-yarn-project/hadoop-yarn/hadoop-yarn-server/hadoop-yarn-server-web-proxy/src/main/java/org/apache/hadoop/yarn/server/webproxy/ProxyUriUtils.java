...
public class ProxyUriUtils {
   ...
   * @param proxyUri
   *     the URI of the proxy itself, scheme, host and port are used.
   * @param id
   *     the id of the application
  ...
  public static URI getProxyUri(URI originalUri, URI proxyUri,
    ...
    try {
      String path =
          getPath(id, originalUri == null ? "/" : originalUri.getPath());
   ...
   *
   * @param id
   *     the id of the application for which the tracking link is desired
   * @param trackingUriPlugins
  ...
  public static URI getUriFromTrackingPlugins(ApplicationId id,
      List<TrackingUriPlugin> trackingUriPlugins) throws URISyntaxException {
    URI toRet = null;
