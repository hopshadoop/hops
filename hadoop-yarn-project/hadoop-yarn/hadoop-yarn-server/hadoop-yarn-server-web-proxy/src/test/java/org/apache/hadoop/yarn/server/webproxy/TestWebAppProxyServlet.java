...
public class TestWebAppProxyServlet {
  ...
  private static final Log LOG =
      LogFactory.getLog(TestWebAppProxyServlet.class);
  ...
  public void testWebAppProxyServlet() throws Exception {
    ...
    try {
      ...
      URL url =
          new URL("http://localhost:" + proxyPort + "/proxy/application_00_0");
      ...
      assertTrue(s.contains(
          "to continue to an Application Master web interface owned by"));
  ...
  private class WebAppProxyForTest extends WebAppProxy {
    ...
    public void start() {
      try {
        ...
        proxyServer = new HttpServer2.Builder().setName("proxy").addEndpoint(
            URI.create(
                WebAppUtils.getHttpSchemePrefix(conf) + bindAddress + ":0"))
