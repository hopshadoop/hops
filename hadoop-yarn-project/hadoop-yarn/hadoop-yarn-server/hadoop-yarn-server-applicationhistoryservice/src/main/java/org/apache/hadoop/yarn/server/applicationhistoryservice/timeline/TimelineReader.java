...
public interface TimelineReader {
  ...
  /**
   * This method retrieves a list of entity information, {@link
   * TimelineEntity},
   * sorted by the starting timestamp for the entity, descending. The starting
   * timestamp of an entity is a timestamp specified by the client. If it is
   * not
   ...
   * @throws IOException
   */
  TimelineEntities getEntities(String entityType, Long limit, Long windowStart,
  ...
  TimelineEvents getEntityTimelines(String entityType,
      ...
      Set<String> eventTypes) throws IOException;
}
