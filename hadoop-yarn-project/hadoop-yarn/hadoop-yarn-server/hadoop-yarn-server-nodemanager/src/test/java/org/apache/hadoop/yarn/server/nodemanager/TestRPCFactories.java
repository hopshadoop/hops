...
public class TestRPCFactories {
  ...
  private void testPbServerFactory() {
    ...
    try {
      server = RpcServerFactoryPBImpl.get()
          .getServer(LocalizationProtocol.class, instance, addr, conf, null, 1);
      server.start();
  ...
  private void testPbClientFactory() {
    ...
    try {
      ...
      try {
        LocalizationProtocol client =
            (LocalizationProtocol) RpcClientFactoryPBImpl.get()
                .getClient(LocalizationProtocol.class, 1,
