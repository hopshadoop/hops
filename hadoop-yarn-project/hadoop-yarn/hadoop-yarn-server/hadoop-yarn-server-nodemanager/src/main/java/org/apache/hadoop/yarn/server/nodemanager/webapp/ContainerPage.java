...
public class ContainerPage extends NMView implements YarnWebParams {
  ...
  public static class ContainerBlock extends HtmlBlock
    ...
    protected void render(Block html) {
      ...
      info("Container information")._("ContainerID", info.getId())
          ._("ContainerState", info.getState())
          ._("ExitStatus", info.getExitStatus())
          ._("Diagnostics", info.getDiagnostics())._("User", info.getUser())
