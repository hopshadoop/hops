...
public class LocalizationProtocolPBClientImpl
  ...
  public LocalizationProtocolPBClientImpl(long clientVersion,
    ...
    proxy = (LocalizationProtocolPB) RPC
        .getProxy(LocalizationProtocolPB.class, clientVersion, addr, conf);
  }
  ...
  public LocalizerHeartbeatResponse heartbeat(LocalizerStatus status)
    ...
    LocalizerStatusProto statusProto =
        ((LocalizerStatusPBImpl) status).getProto();
    try {
