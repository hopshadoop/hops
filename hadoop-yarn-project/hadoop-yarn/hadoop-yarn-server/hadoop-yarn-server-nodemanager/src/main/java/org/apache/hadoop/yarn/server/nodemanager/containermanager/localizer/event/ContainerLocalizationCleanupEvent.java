...
public class ContainerLocalizationCleanupEvent
    extends ContainerLocalizationEvent {
  ...
  public Map<LocalResourceVisibility, Collection<LocalResourceRequest>> getResources() {
    return rsrc;
  }
}