...
public class FairSchedulerConfiguration extends Configuration {
  ...
  public static final Log LOG =
      LogFactory.getLog(FairSchedulerConfiguration.class.getName());
  ...
  protected static final String ALLOW_UNDECLARED_POOLS =
      CONF_PREFIX + "allow-undeclared-pools";
  ...
  protected static final String USER_AS_DEFAULT_QUEUE =
      CONF_PREFIX + "user-as-default-queue";
  ...
  protected static final String LOCALITY_THRESHOLD_NODE =
      CONF_PREFIX + "locality.threshold.node";
  ...
  protected static final String LOCALITY_THRESHOLD_RACK =
      CONF_PREFIX + "locality.threshold.rack";
  ...
  protected static final String LOCALITY_DELAY_NODE_MS =
      CONF_PREFIX + "locality-delay-node-ms";
  ...
  protected static final String LOCALITY_DELAY_RACK_MS =
      CONF_PREFIX + "locality-delay-rack-ms";
  ...
  protected static final String CONTINUOUS_SCHEDULING_ENABLED =
      CONF_PREFIX + "continuous-scheduling-enabled";
  ...
  protected static final String CONTINUOUS_SCHEDULING_SLEEP_MS =
      CONF_PREFIX + "continuous-scheduling-sleep-ms";
  ...
  public String getEventlogDir() {
    return get(EVENT_LOG_DIR,
        new File(System.getProperty("hadoop.log.dir", "/tmp/"))
            .getAbsolutePath() + File.separator + "fairscheduler");
  }
