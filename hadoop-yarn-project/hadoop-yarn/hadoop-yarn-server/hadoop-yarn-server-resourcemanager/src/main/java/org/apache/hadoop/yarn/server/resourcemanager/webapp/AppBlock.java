...
public class AppBlock extends HtmlBlock {
  ...
  protected void render(Block html) {
    ...
    AppInfo app =
        new AppInfo(rmApp, true, WebAppUtils.getHttpSchemePrefix(conf));
    ...
    info("Application Overview").
        ...
        _("Elapsed:", StringUtils
            .formatTime(Times.elapsed(app.getStartTime(), app.getFinishTime())))
        .
            _("Tracking URL:",
    ...
    for (RMAppAttempt attempt : attempts) {
      ...
      table.tr((odd = !odd) ? _ODD : _EVEN).
          ...
          td().a(".nodelink", url("//", attemptInfo.getNodeHttpAddress()),
