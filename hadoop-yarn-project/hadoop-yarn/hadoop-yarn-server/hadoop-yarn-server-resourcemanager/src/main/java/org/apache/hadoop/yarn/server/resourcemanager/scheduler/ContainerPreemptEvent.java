...
/**
 * Simple event class used to communicate containers unreservations, preemption,
 * killing
 */
public class ContainerPreemptEvent
    extends AbstractEventTransaction<ContainerPreemptEventType> {

  private final ApplicationAttemptId aid;
  private final RMContainer container;

  public ContainerPreemptEvent(ApplicationAttemptId aid, RMContainer container,
      ContainerPreemptEventType type, TransactionState transactionState) {
