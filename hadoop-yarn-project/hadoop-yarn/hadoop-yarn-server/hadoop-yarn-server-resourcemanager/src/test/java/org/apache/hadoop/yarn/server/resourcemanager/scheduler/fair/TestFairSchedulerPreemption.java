...
public class TestFairSchedulerPreemption extends FairSchedulerTestBase {
    ...
    private void registerNodeAndSubmitApp(
        ...
        NodeAddedSchedulerEvent nodeEvent1 = new NodeAddedSchedulerEvent(node1, new TransactionStateImpl(
        ...
        for (int i = 0; i < 3; i++) {
            NodeUpdateSchedulerEvent nodeUpdate1 = new NodeUpdateSchedulerEvent(node1, new TransactionStateImpl(
                    TransactionState.TransactionType.RM));
