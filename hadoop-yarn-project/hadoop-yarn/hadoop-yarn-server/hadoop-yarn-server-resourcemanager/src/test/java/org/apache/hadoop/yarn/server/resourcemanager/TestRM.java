...
public class TestRM {
  ...
  public void testGetNewAppId() throws Exception {
    ...
    try {
      ...
      //HOP :: Stop RM to destroy PendingEvent retrieval thread as well
      rm.stop();
    }
  }
  ...
  public void testNMTokenSentForNormalContainer() throws Exception {
    ...
    try {
      ...
      cs.getApplicationAttempt(attempt.getAppAttemptId()).
          getNewContainerId(null);
  ...
  //@Test (timeout = 120000)
  public void testNMTokenLoop() throws Exception {
    for (int i = 0; i < 10; i++) {
      LOG.debug("HOP :: testNMTokenLoop-START-" + i);
      testNMToken();
      LOG.debug("HOP :: testNMTokenLoop-FINISH-" + i);
      setup();
    }
  }
  ...
  public void testNMToken() throws Exception {
    ...
    try {
      ...
      NMTokenSecretManagerInRM nmTokenSecretManager = rm.getRMContext().
      ...
      Map<NodeId, RMNode> nodes = rm.getRMContext().getActiveRMNodes();
  ...
  protected void allocateContainersAndValidateNMTokens(MockAM am,
      ...
      HashMap<String, Token> nmTokens, MockNM nm)
    ...
    while (containersReceived.size() < totalContainerRequested) {
      ...
      LOG.info(
          "Got " + containersReceived.size() + " containers. Waiting to get " +
              totalContainerRequested);
      Thread.sleep(WAIT_SLEEP_MS);
    }
  }
  ...
  public void testActivatingApplicationAfterAddingNM() throws Exception {
    ...
    try {
      ...
      MockNM nm1 =
          new MockNM("h1:1234", 15120, rm1.getResourceTrackerService());
      MockNM nm2 =
          new MockNM("h2:5678", 15120, rm1.getResourceTrackerService());
      nm1.registerNode();
      nm2.registerNode();
  ...
  public void testInvalidateAMHostPortWhenAMFailedOrKilled() throws Exception {
    ...
    try {
      ...
      GetApplicationsRequest request1 = GetApplicationsRequest.newInstance(
          EnumSet.of(YarnApplicationState.FINISHED, YarnApplicationState.KILLED,
              YarnApplicationState.FAILED));
      GetApplicationsResponse response1 = rm1.getClientRMService().
          getApplications(request1);
  ...
  public void testInvalidatedAMHostPortOnAMRestart() throws Exception {
    ...
    try {
      ...
      // host and port.
      GetApplicationReportRequest request1 = GetApplicationReportRequest.
          newInstance(app2.getApplicationId());
  ...
  public void testApplicationKillAtAcceptedState() throws Exception {
    ...
    try {
      ...
      MockNM nm1 = new MockNM("127.0.0.1:1234", 15120, rm.
          getResourceTrackerService());
      nm1.registerNode();
      ...
      rm.getRMContext().getDispatcher().getEventHandler().handle(
          new RMAppEvent(application.getApplicationId(),
              RMAppEventType.ATTEMPT_KILLED, null));
