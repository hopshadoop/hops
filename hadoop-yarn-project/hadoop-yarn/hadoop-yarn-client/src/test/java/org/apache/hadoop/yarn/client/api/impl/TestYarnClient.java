...
public class TestYarnClient {
  ...
  public void testSubmitApplication() {
    ...
    YarnApplicationState[] exitStates =
        new YarnApplicationState[]{YarnApplicationState.SUBMITTED,
    ...
    for (int i = 0; i < exitStates.length; ++i) {
      ...
      ApplicationId applicationId =
          ApplicationId.newInstance(System.currentTimeMillis(), i);
  ...
  public void testApplicationType() throws Exception {
    ...
    rm.start();
    RMApp app = rm.submitApp(2000);
    RMApp app1 = rm.submitApp(200, "name", "user",
  ...
  public void testGetApplications() throws YarnException, IOException {
    ...
    Assert.assertTrue((reports.get(0).getApplicationType().equals("YARN") &&
  ...
  public void testGetApplicationAttempt() throws YarnException, IOException {
    ...
    List<ApplicationReport> expectedReports =
        ((MockYarnClient) client).getReports();
  ...
  public void testGetContainerReport() throws YarnException, IOException {
    ...
    Assert.assertEquals(report.getContainerId().toString(), (ContainerId
            .newInstance(
                expectedReports.get(0).getCurrentApplicationAttemptId(), 1))
            .toString());
    client.stop();
  }
  ...
  private static class MockYarnClient extends YarnClientImpl {
    ...
    public void start() {
      ...
      try {
        ...
        when(rmClient.forceKillApplication(any(KillApplicationRequest.class)))
            .thenReturn(KillApplicationResponse.newInstance(false)).
            thenReturn(KillApplicationResponse.newInstance(true));
        when(rmClient.getApplicationAttemptReport(
                any(GetApplicationAttemptReportRequest.class)))
            .thenReturn(mockAttemptResponse);
        when(rmClient.getApplicationAttempts(
                any(GetApplicationAttemptsRequest.class))).
    ...
    public void setYarnApplicationState(YarnApplicationState state) {
      when(mockReport.getYarnApplicationState())
          .thenReturn(YarnApplicationState.NEW, YarnApplicationState.NEW_SAVING,
    ...
    private List<ApplicationReport> createAppReports() {
      ...
      ApplicationAttemptReport attempt = ApplicationAttemptReport
          .newInstance(ApplicationAttemptId.newInstance(applicationId, 1),
              "host", 124, "url", "diagnostics",
      ...
      ApplicationAttemptReport attempt1 = ApplicationAttemptReport
          .newInstance(ApplicationAttemptId.newInstance(applicationId, 2),
              "host", 124, "url", "diagnostics",
              YarnApplicationAttemptState.FINISHED, ContainerId.newInstance(
      ...
      ApplicationReport newApplicationReport2 =
          ApplicationReport.newInstance(applicationId2, ApplicationAttemptId.
                  newInstance(applicationId2, 2), "user2", "queue2", "appname2",
              "host2", 125, null, YarnApplicationState.FINISHED, "diagnostics2",
              "url2", 2, 2, FinalApplicationStatus.SUCCEEDED, null, "N/A",
              0.63789f, "NON-YARN", null);
      applicationReports.add(newApplicationReport2);

      ApplicationId applicationId3 = ApplicationId.newInstance(1234, 7);
      ApplicationReport newApplicationReport3 =
          ApplicationReport.newInstance(applicationId3, ApplicationAttemptId.
                  newInstance(applicationId3, 3), "user3", "queue3", "appname3",
              "host3", 126, null, YarnApplicationState.RUNNING, "diagnostics3",
              "url3", 3, 3, FinalApplicationStatus.SUCCEEDED, null, "N/A",
              0.73789f, "MAPREDUCE", null);
    ...
    public List<ApplicationAttemptReport> getApplicationAttempts(
      ...
      when(mockAppAttemptsResponse.getApplicationAttemptList())
          .thenReturn(getAttempts(appId));
    ...
    public ApplicationAttemptReport getApplicationAttemptReport(
      ...
      when(mockAttemptResponse.getApplicationAttemptReport())
          .thenReturn(getAttempt(appAttemptId));
    ...
    public List<ContainerReport> getContainers(
        ApplicationAttemptId appAttemptId) throws YarnException, IOException {
      when(mockContainersResponse.getContainerList())
          .thenReturn(getContainersReport(appAttemptId));
    ...
    public ContainerReport getContainerReport(ContainerId containerId)
        throws YarnException, IOException {
      when(mockContainerResponse.getContainerReport())
          .thenReturn(getContainer(containerId));
    ...
    public ApplicationAttemptReport getAttempt(
        ApplicationAttemptId appAttemptId) {
  ...
  private void waitTillAccepted(YarnClient rmClient, ApplicationId appId)
    ...
    try {
      ...
      while (YarnApplicationState.ACCEPTED !=
  ...
  private void testAsyncAPIPollTimeoutHelper(Long valueForTimeout,
    ...
    try {
      ...
      Assert.assertEquals(expectedTimeoutEnforcement,
          client.enforceAsyncAPITimeout());
    } finally {
