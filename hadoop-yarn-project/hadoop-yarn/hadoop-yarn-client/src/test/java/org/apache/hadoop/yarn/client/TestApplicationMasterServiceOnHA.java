...
public class TestApplicationMasterServiceOnHA extends ProtocolHATestBase {
  ...
  public void initiate() throws Exception {
    ...
    amClient =
        ClientRMProxy.createRMProxy(this.conf, ApplicationMasterProtocol.class);

    AMRMTokenIdentifier id = new AMRMTokenIdentifier(attemptId);
    Token<AMRMTokenIdentifier> appToken = new Token<AMRMTokenIdentifier>(id,
  ...
  public void testAllocateOnHA() throws YarnException, IOException {
    AllocateRequest request = AllocateRequest
        .newInstance(0, 50f, new ArrayList<ResourceRequest>(),
