...
public class TestAMRMClientContainerRequest {
  ...
  public void testDisableLocalityRelaxation() {
    ...
    ContainerRequest nodeLevelRequest =
        new ContainerRequest(capability, new String[]{"host1", "host2"}, null,
            Priority.newInstance(1), false);
    ...
    ContainerRequest nodeLevelRequest2 =
        new ContainerRequest(capability, new String[]{"host2", "host3"}, null,
            Priority.newInstance(1), false);
    ...
    ContainerRequest bothLevelRequest =
        new ContainerRequest(capability, new String[]{"host3", "host4"},
            new String[]{"rack1", "/otherrack"}, Priority.newInstance(3),
            false);
    ...
    ContainerRequest bothLevelRequest2 =
        new ContainerRequest(capability, new String[]{"host4", "host5"},
            new String[]{"rack1", "/otherrack2"}, Priority.newInstance(3),
            false);
  ...
  public void testDifferentLocalityRelaxationSamePriority() {
    ...
    ContainerRequest request2 =
        new ContainerRequest(capability, new String[]{"host3"}, null,
            Priority.newInstance(1), true);
  ...
  public void testInvalidValidWhenOldRemoved() {
    ...
    ContainerRequest request4 =
        new ContainerRequest(capability, null, new String[]{"rack1"},
            Priority.newInstance(1), true);
  ...
  private void verifyResourceRequest(AMRMClientImpl<ContainerRequest> client,
      ContainerRequest request, String location,
      boolean expectedRelaxLocality) {
    ResourceRequest ask =
        client.remoteRequestsTable.get(request.getPriority()).get(location)
            .get(request.getCapability()).remoteRequest;
