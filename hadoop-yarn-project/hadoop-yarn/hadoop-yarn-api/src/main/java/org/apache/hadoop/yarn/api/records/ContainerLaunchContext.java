...
public abstract class ContainerLaunchContext {
   ...
   *     <code>LocalResource</code> required by the container
   */
  @Public
  @Stable
   ...
   *
   * @param environment
   *     <em>environment variables</em> for the container
   */
  @Public
  @Stable
   ...
   *
   * @param commands
   *     the list of <em>commands</em> for launching the container
   */
  @Public
  @Stable
   ...
   *
   * @param acls
   *     <code>ApplicationACL</code>s for the application
   */
  @Public
  @Stable
