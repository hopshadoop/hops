...
public class UnmanagedAMLauncher {
  ...
  public void launchAM(ApplicationAttemptId attemptId)
    ...
    DataOutputStream os =
        new DataOutputStream(new FileOutputStream(tokenFile, true));
    ...
    final BufferedReader errReader =
        new BufferedReader(new InputStreamReader(amProc.getErrorStream()));
    final BufferedReader inReader =
        new BufferedReader(new InputStreamReader(amProc.getInputStream()));
  ...
  public boolean run() throws IOException, YarnException {
    ...
    try {
      ...
      ApplicationSubmissionContext appContext =
          rmClient.createApplication().getApplicationSubmissionContext();
      ...
      ApplicationReport appReport = monitorApplication(appId, EnumSet
          .of(YarnApplicationState.ACCEPTED, YarnApplicationState.KILLED,
      ...
      if (appReport.getYarnApplicationState() ==
        ...
        appReport = monitorApplication(appId, EnumSet
  ...
  private ApplicationAttemptReport monitorCurrentAppAttempt(ApplicationId appId,
    ...
    while (true) {
      if (attemptId == null) {
        attemptId = rmClient.getApplicationReport(appId)
  ...
  private ApplicationReport monitorApplication(ApplicationId appId,
    ...
    while (true) {
      ...
      LOG.info(
          "Got application report from ASM for" + ", appId=" + appId.getId() +
              ", appAttemptId=" + report.getCurrentApplicationAttemptId() +
              ", clientToAMToken=" + report.getClientToAMToken() +
              ", appDiagnostics=" + report.getDiagnostics() +
              ", appMasterHost=" + report.getHost() + ", appQueue=" +
              report.getQueue() + ", appMasterRpcPort=" + report.getRpcPort() +
