...
public abstract class ResourceCalculator {
  ...
  public abstract int compare(Resource clusterResource, Resource lhs,
      Resource rhs);
   ...
   */
  public abstract int computeAvailableContainers(Resource available,
      Resource required);
   ...
   */
  public abstract Resource multiplyAndNormalizeUp(Resource r, double by,
      Resource stepFactor);
   ...
   * @return resulting normalized resource
   */
  public abstract Resource multiplyAndNormalizeDown(Resource r, double by,
      Resource stepFactor);
   ...
   * @param r
   *     resource
   * @param minimumResource
   *     step-factor
   * @param maximumResource
   *     the upper bound of the resource to be allocated
   ...
   */
  public abstract float divide(Resource clusterResource, Resource numerator,
