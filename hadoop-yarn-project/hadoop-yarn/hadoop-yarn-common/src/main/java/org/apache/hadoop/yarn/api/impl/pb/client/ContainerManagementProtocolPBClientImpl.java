...
public class ContainerManagementProtocolPBClientImpl
    implements ContainerManagementProtocol, Closeable {

  // Not a documented config. Only used for tests
  static final String NM_COMMAND_TIMEOUT =
      YarnConfiguration.YARN_PREFIX + "rpc.nm-command-timeout";
  ...
  public ContainerManagementProtocolPBClientImpl(long clientVersion,
    ...
    proxy = (ContainerManagementProtocolPB) RPC
        .getProxy(ContainerManagementProtocolPB.class, clientVersion, addr, ugi,
            conf, NetUtils.getDefaultSocketFactory(conf), expireIntvl);
  }
  ...
  public StartContainersResponse startContainers(
    ...
    try {
      return new StartContainersResponsePBImpl(
          proxy.startContainers(null, requestProto));
  ...
  public StopContainersResponse stopContainers(StopContainersRequest requests)
    ...
    try {
      return new StopContainersResponsePBImpl(
          proxy.stopContainers(null, requestProto));
    } catch (ServiceException e) {
      RPCUtil.unwrapAndThrowException(e);
      return null;
    }
  ...
  public GetContainerStatusesResponse getContainerStatuses(
    ...
    try {
      return new GetContainerStatusesResponsePBImpl(
          proxy.getContainerStatuses(null, requestProto));
    } catch (ServiceException e) {
      RPCUtil.unwrapAndThrowException(e);
      return null;
    }
