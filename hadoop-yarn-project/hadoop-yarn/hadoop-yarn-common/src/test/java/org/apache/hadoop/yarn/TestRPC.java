...
public class TestRPC {
  ...
  public void testUnknownCall() {
    ...
    conf.set(YarnConfiguration.IPC_RPC_IMPL,
        HadoopYarnProtoRPC.class.getName());
    ...
    ApplicationClientProtocol proxy = (ApplicationClientProtocol) rpc
        .getProxy(ApplicationClientProtocol.class,
  ...
  private void test(String rpcClass) throws Exception {
    ...
    ContainerTokenIdentifier containerTokenIdentifier =
        new ContainerTokenIdentifier(containerId, "localhost", "user", resource,
            System.currentTimeMillis() + 10000, 42, 42);
  ...
  public class DummyContainerManager implements ContainerManagementProtocol {
    ...
    public StopContainersResponse stopContainers(StopContainersRequest request)
      ...
      Exception e =
          new Exception(EXCEPTION_MSG, new Exception(EXCEPTION_CAUSE));
