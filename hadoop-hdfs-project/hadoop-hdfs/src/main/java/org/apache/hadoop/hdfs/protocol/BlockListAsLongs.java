      ...
      return new Iterator<BlockReportReplica>() {
        ...
        public BlockReportReplica next() {
          ...
          try {
            ...
            block.setBlockIdNoPersistance(cis.readSInt64());
            block.setNumBytesNoPersistance(cis.readRawVarint64() & NUM_BYTES_MASK);
            block.setGenerationStampNoPersistance(cis.readRawVarint64());
    ...
    public Iterator<BlockReportReplica> iterator() {
      return new Iterator<BlockReportReplica>() {
        ...
        private void readBlock() {
          block.setBlockIdNoPersistance(iter.next());
          block.setNumBytesNoPersistance(iter.next());
          block.setGenerationStampNoPersistance(iter.next());
        }
