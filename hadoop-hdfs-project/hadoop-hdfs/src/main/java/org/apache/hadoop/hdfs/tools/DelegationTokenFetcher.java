...
public class DelegationTokenFetcher {
  ...
  private static void printUsage(PrintStream err) {
    ...
    err.println(
        "  --renew             Renew the delegation token.  Delegation " +
  ...
  public static void main(final String[] args) throws Exception {
    ...
    final String renewer =
        cmd.hasOption(RENEWER) ? cmd.getOptionValue(RENEWER) : null;
    ...
    if (cancel && renew || cancel && print || renew && print ||
        cancel && renew && print) {
              ...
              public Object run() throws Exception {
                if (print) {
                  DelegationTokenIdentifier id =
                      new DelegationTokenSecretManager(0, 0, 0, 0, null)
                          .createIdentifier();
                ...
                if (renew) {
                  ...
                  if (webUrl != null) {
                    ...
                    for (Token<?> token : tokens) {
                      System.out.println(
                          "Fetched token for " + token.getService() + " into " +
                              tokenFile);
                    }
                  }
                }
  ...
  static private IOException getExceptionFromResponse(HttpURLConnection con) {
    ...
    try {
      ...
      java.lang.reflect.Constructor<? extends Exception> constructor =
          (java.lang.reflect.Constructor<? extends Exception>) ec
