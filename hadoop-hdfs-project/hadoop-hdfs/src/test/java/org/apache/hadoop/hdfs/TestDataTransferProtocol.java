...
public class TestDataTransferProtocol {
  ...
  private static final Log LOG =
      LogFactory.getLog("org.apache.hadoop.hdfs.TestDataTransferProtocol");
  ...
  private void sendRecvData(String testDescription, boolean eofExpected)
      throws IOException {
  ...
  private void sendResponse(Status status, String firstBadLink, String message,
  ...
  public void testOpWrite() throws IOException {
    ...
    try {
      ...
      testWrite(firstBlock, BlockConstructionStage.PIPELINE_SETUP_APPEND, newGS,
      ...
      firstBlock = DFSTestUtil.getFirstBlock(fileSys, file);
      newGS = firstBlock.getGenerationStamp() + 1;
      testWrite(firstBlock, BlockConstructionStage.PIPELINE_CLOSE_RECOVERY,
      ...
      newGS = newBlock.getGenerationStamp() + 1;
      testWrite(newBlock, BlockConstructionStage.PIPELINE_SETUP_APPEND, newGS,
          "Cannot append to a new block", true);

      // test PIPELINE_SETUP_APPEND_RECOVERY on a new block
      newBlock.setBlockId(newBlock.getBlockId() + 1);
      newGS = newBlock.getGenerationStamp() + 1;
      testWrite(newBlock, BlockConstructionStage.PIPELINE_SETUP_APPEND_RECOVERY,
          newGS, "Cannot append to a new block", true);
  ...
  public void testDataTransferProtocol() throws IOException {
    ...
    try {
      ...
      // bad version
      recvOut
          .writeShort((short) (DataTransferProtocol.DATA_TRANSFER_VERSION - 1));
      sendOut
          .writeShort((short) (DataTransferProtocol.DATA_TRANSFER_VERSION - 1));
    ...
    /* Test OP_READ_BLOCK */
      ...
      recvBuf.reset();
      sendResponse(Status.ERROR, null, "opReadBlock " + firstBlock +
