...
public class TestViewFileSystemHdfs extends ViewFileSystemBaseTest {
  ...
  public static void clusterSetupAtBegining()
    ...
    cluster = new MiniDFSCluster.Builder(CONF)
        .nnTopology(MiniDFSNNTopology.simpleHOPSTopology(2)).numDataNodes(2)
        .build();
    ...
    defaultWorkingDirectory2 = fHdfs2.makeQualified(new Path(
        "/user/" + UserGroupInformation.getCurrentUser().getShortUserName()));
  ...
  public void setUp() throws Exception {
    ...
    fsTarget2 = fHdfs2;
    targetTestRoot2 =
        new FileSystemTestHelper().getAbsoluteTestRootPath(fsTarget2);
    super.setUp();
  }
  ...
  void setupMountPoints() {
    ...
    ConfigUtil.addLink(conf, "/mountOnNn2",
        new Path(targetTestRoot2, "mountOnNn2").toUri());
  }
