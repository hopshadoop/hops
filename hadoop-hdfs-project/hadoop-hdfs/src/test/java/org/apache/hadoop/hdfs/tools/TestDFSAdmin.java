...
public class TestDFSAdmin {
  ...
  public void testGetReconfigurationStatus()
    ...
    assertThat(admin.startReconfiguration("datanode", address), is(-1));
    ...
    assertThat(outputs.get(offset),
        containsString("SUCCESS: Change property " + DFS_DATANODE_DATA_DIR_KEY));
    assertThat(outputs.get(offset + 1),
        is(allOf(containsString("From:"), containsString("data_0_0"),
            containsString("data_0_1"))));
