...
public class TestNameNodeJspHelper {
  ...
  public static void setUp() throws Exception {
    ...
    cluster = new MiniDFSCluster.Builder(conf).numDataNodes(DATA_NODES_AMOUNT).build();
    cluster.waitActive();
  }
  ...
  public void testDelegationToken() throws IOException, InterruptedException {
    ...
    String tokenString =
        NamenodeJspHelper.getDelegationToken(nn, request, conf, ugi);
  ...
  @Test(timeout = 15000)
  public void testGetInodeLimitText() throws IOException {
    NameNode nameNode = cluster.getNameNode();
  ...
  public void testGetVersionTable() {
    ...
    String line = NamenodeJspHelper.getVersionTable(fsn, cluster.getNameNode());
    for(String pattern: patterns) {
