...
public class TestJsonUtil {
  ...
  public void testHdfsFileStatus() throws IOException {
    ...
    final HdfsFileStatus status = new HdfsFileStatus(1001L, false, 3, 1L << 26,
        ...
        HdfsConstantsClient.GRANDFATHER_INODE_ID, 0, null, false/*not stored in the database*/, (byte) 0);
  ...
  @Test
  public void testToDatanodeInfoWithoutSecurePort() throws IOException {
