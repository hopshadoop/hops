...
public class TestDelegationTokenRemoteFetcher {
   ...
   */
  @Test
  public void testRenewTokenFromHttp() throws IOException, AuthenticationException {
    bootstrap = startHttpServer(httpPort, testToken, serviceUrl);
    assertTrue("testRenewTokenFromHttp error",
        Long.valueOf(EXP_DATE) == DelegationTokenFetcher.renewDelegationToken( connectionFactory,
