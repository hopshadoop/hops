...
public class TestTracing {
  ...
  //this test is not working because we are not at the same point in the merges for common and for hdfs
  //we should put the test back once we have reached the same point in hdfs
  @Ignore 
  @Test
