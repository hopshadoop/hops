...
import static io.hops.erasure_coding.ReedSolomonCode.LOG;
...
public class NativeReedSolomonCode extends ErasureCode {
  ...
  NativeRSRawDecoder decoder;
    ...
    private void init(int stripeSize, int paritySize) {
        ...
        encoder = (NativeRSRawEncoder) factory.createEncoder(this.stripeSize, this.paritySize);
        decoder = (NativeRSRawDecoder) factory.createDecoder(this.stripeSize, this.paritySize);
    }
