...
public class TestNativeErasureCodes extends TestCase {
  ...
  public void testNativeEncodeDecode() {
    ...
    for (int n = 0; n < TEST_CODES; n++) {
      ...
      NativeRSRawEncoder enc = (NativeRSRawEncoder) factory.createEncoder(stripeSize, paritySize);
      NativeRSRawDecoder dec = (NativeRSRawDecoder) factory.createDecoder(stripeSize, paritySize);
